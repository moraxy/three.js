...
function WebGLUtils( gl, extensions, capabilities ) {
	...
	function convert( p ) {
		...
		if ( p === DepthComponent16Format ) return gl.DEPTH_COMPONENT16;
		if ( p === DepthComponent24Format ) return gl.DEPTH_COMPONENT24;
		if ( p === DepthComponent32FFormat ) return gl.DEPTH_COMPONENT32F;
		if ( p === Depth24Stencil8Format ) return gl.DEPTH24_STENCIL8;
		if ( p === Depth32FStencil8Format ) return gl.DEPTH32F_STENCIL8;
